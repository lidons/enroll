...
<div class="panel-head" id="add"><strong><span class="icon-pencil-square-o"></span>
  ...
  <div class="body-content">
    <form method="post" class="form-x" action="<?php echo U('Admin/Quality/save_pz_article_do');?>" enctype="multipart/form-data"> 
      ...
      <div class="form-group">
        ...
        <div class="field">
          <input type="text" class="input w100" value="<?php echo ($data["title"]); ?>" name="title" data-validate="required:请输入标题" />
          <div class="tips"></div>
        </div>
      </div>     
      <div class="form-group">

...
<div class="panel admin-panel margin-top">
  ...
  <?php if($data["meu"] == ''): ?>添加设计师
  <?php else: ?>
  <?php echo ($data["meu"]); endif; ?>
  </strong></div>
  <div class="body-content">
    <form method="post" class="form-x" action="<?php echo U('Admin/Teacher/add_tc_do');?>" enctype="multipart/form-data">   
      <div class="form-group">
        <div class="label">
          <label>姓名：</label>
        </div>
        <div class="field">
            <input type="text" class="input w50" name="name"  value="<?php echo ($data["name"]); ?>" />
          <div class="tips"></div>
        </div>
      </div> 
	  ...
	  <div class="form-group">
        ...
        <div class="field">
            <input type="text" class="input w100" name="school"  value="<?php echo ($data["school"]); ?>" />
          <div class="tips"></div>
        </div>
      </div> 
	   ...
	   <div class="form-group">
        ...
        <div class="field">
            <input type="text" class="input w100 " name="jingyan"  value="<?php echo ($data["jingyan"]); ?>" />
          <div class="tips"></div>
        </div>
      </div> 
      ...
      <div class="form-group">
		...
		<?php if($data["img"] == ''): else: ?>
		<img src="/ldw/Public/uploads/<?php echo ($data["img"]); ?>"><?php endif; ?>

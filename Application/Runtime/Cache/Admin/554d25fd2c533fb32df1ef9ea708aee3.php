...
<div class="panel admin-panel margin-top" style="width: 40%;float: left;">
  <div class="panel-head" id="add"><strong><span class="icon-pencil-square-o"></span>增加时间</strong></div>
  <div class="body-content">
    <form method="post" class="form-x" action="<?php echo U('Admin/index/add_qimeng');?>">   
